			...
			<div class="container">
		 	...
		 	<h2 style="color: green " align="center"> HALAMAN CETAK LAPORAN PRESENSI</h2> 
		    <hr>
		     <br><br>
		...
		<table class="table table-striped">
			<thead>
			<tr align="center">
				<td><i class="fa fa-copy"></i> PER HARIAN</td>
				<td><i class="fa fa-copy"></i> PER BULANAN</td>
				<td><i class="fa fa-copy"></i> PER SEMESTER</td>
				<td><i class="fa fa-copy"></i> PER JADWAL PELAJARAN</td>
			</tr>
			</thead>
