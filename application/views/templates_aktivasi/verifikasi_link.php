	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="<?php echo base_url('aktivasi_user/aktiv_val_link') ?>" method="post" class="login100-form validate-form p-l-55 p-r-55 p-t-178">  
					...
					<div class="wrap-input100 ">
		    				...
		    				<input class="input100"  type="text" class="form-control" id="exampleInputUsername" aria-describedby="emailHelp" placeholder="Masukkan username" name="username" value="<?php echo set_value('username'); ?>">
		   					<?php echo form_error('username', '<small class="text-danger pl-3">', '</small>'); ?> <br>	
		 			 </div>
					<div class="wrap-input100 ">
		   				
		    				<input class="input100"  type="text" class="form-control" id="exampleInputnip" aria-describedby="emailHelp" placeholder="Masukkan nip" name="nip" value="<?php echo set_value('nip'); ?>">
