        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;" >
              <a class="site_title" href=" <?php echo base_url(); ?>Guru/index">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url(); ?>guru/index"><i class="fa fa-home"></i> Beranda </span></a>
                  ...
                  <li><a><i class="fa fa-edit"></i> Profil Diri <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo base_url(); ?>Guru/bio_guru/<?php echo $this->session->userdata('id'); ?>"> Lihat Biodata diri</a></li>
                      <li><a href="<?php echo base_url(); ?>Guru/edit_pass/<?php echo $this->session->userdata('id'); ?>">Edit Password</a></li>        
                    </ul>
                  </li>
...
<script src="http://code.highcharts.com/highcharts.js"></script>
  ...
  <script src="<?php echo base_url('vendor') ?>/contactform/contactform.js"></script>
