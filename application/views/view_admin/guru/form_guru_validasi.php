    ...
    <?php } ?>
          ...
          <form action="<?php echo base_url(); ?>admin/tambah_guru" method ="post"  class="form-horizontal form-label-left" enctype="multipart/form-data" >
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="date" id="tgl_lahir" name="tgl_lahir" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" readonly value="<?php echo set_value('tgl_lahir'); ?>">
                        </div>
                      </div>
                   ...
                   <label class="control-label col-md-4 col-sm-3 col-xs-12" for="id_user"> NAMA AKUN <span class="required">*</span>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <?php foreach ($users as $l  ): ?>
                           ...
                           <option value="<?php echo $l->id ?>" <?php echo ($l->id == $validasi_akun)?'selected="selected"':''?>><?php echo $l->username?></option>
