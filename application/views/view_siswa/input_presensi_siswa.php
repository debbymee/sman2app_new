        <div class="x_panel">
			<div class="container">
		 	...
		 	<h2 style="color: black;font-size: 22px " align="center"><b> DAFTAR PRESENSI SISWA KELAS 12</b></h2>
		    <hr>
		     <br><br>
		 ...
		 <form action="<?php echo base_url(); ?>siswa_admin/tambah_presensi12" method ="post"  class="form-horizontal form-label-left" enctype="multipart/form-data" >
 ...
 <table>
 	...
 	<tr>
 		...
 		<td><h2 style="color: #000 " id="kelas"><b>KELAS</b></h2></td>
 		<td><h2 style="color: #000 " id="kelas"><b> : <?php echo $kelas?></b></h2></td>
 	
 	</tr>
 	<tr>
 		<td><h2 style="color: #000 " id="jadwal_pelajaran"><b>JADWAL PELAJARAN</b></h2></td>
 		<td><h2 style="color: #000 " id="jadwal_pelajaran"><b>  : <select class="btn btn-default dropdown-toggle" id="jadwal" name="id_jadwal" >
