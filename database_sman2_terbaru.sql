...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Feb 2020 pada 10.42
...
(12, 10, 18, '197607202006041009', 18),
...
(15, 'Putra / putri anda atas nama \'Achmad Fauzi\' Hari ini tidak masuk dengan keterangan \'Absen\'. Demikian pemberitahuan kami, Terima kasih', '2020-02-10', '14:43', 334, '196908272006042009');
...
(23, 'Jumat', 'jam ke-1', 6, 16, 18, 954),
(24, 'Senin', 'jam ke-1', 6, 15, 18, 913),
(25, 'Senin', 'jam ke-3', 2, 15, 18, 954),
(26, 'Senin', 'jam ke-5', 3, 16, 18, 913),
(27, 'Senin', 'jam ke-7', 6, 18, 18, 913);
...
(292, '2020-03-08', '', 'bahasa yyy', 'A', 23, 1),
(334, '2020-02-10', '', 'bahasa indoooo', 'A', 24, 21),
(335, '2020-02-10', '', 'bahasa indoooo', 'A', 24, 22),
(336, '2020-02-10', '', 'bahasa indoooo', 'H', 24, 23),
(337, '2020-02-10', '', 'tezz', 'D', 27, 10),
(338, '2020-02-10', '', 'mikro', 'A', 25, 21),
(339, '2020-02-10', NULL, 'mikro', 'A', 25, 22),
(340, '2020-02-10', NULL, 'mikro', 'A', 25, 23);
...
--
ALTER TABLE `presensi`
  MODIFY `id_presensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=341;
